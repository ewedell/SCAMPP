...
In addition in the command prompt or wherever make sure to set the following before running measure_all.sh/measure_st.sh/measure_app.sh or anything that uses compareTrees.missingBranch :
